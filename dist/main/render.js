...
function RenderField(_a) {
    ...
    // ----------------------------------------------------------------- RENDER
    return ((0, jsx_runtime_1.jsxs)("div", { className: "space-y-2 rounded-lg max-w-full min-w-0 flex flex-col", children: [(_field === null || _field === void 0 ? void 0 : _field.label) && ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-4 w-full", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-sm font-semibold text-gray-700", children: _field.label }), (_field === null || _field === void 0 ? void 0 : _field.required) && ((0, jsx_runtime_1.jsx)("span", { className: "text-xl text-red-500 font-bold", children: "*" })), (_field === null || _field === void 0 ? void 0 : _field.hint) && ((0, jsx_runtime_1.jsx)("span", { className: "text-gray-400 cursor-help select-none", title: _field.hint, "aria-label": "Hint", children: "\u24D8" }))] })), (0, jsx_runtime_1.jsx)("div", { className: "flex", children: (0, jsx_runtime_1.jsx)(react_hook_form_1.Controller, { name: name, control: control, rules: {
